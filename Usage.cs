    ...
    public static class Usage
    {
        public static void Print()
        {
            Console.WriteLine($"" +
                ...
                $"-fa= 开机时是否安装完整MagiskAPP（即集成完整APP到boot，要求分区空间足够）\r\n" +
                $"     此选项在面具25200及更低版本无效，强制为false；在25210及更高版本默认为false\r\n" +
                ...
                $"     注：riscv_64目前只在面具27005和27006版本可用\r\n" +
                $"-kv= 指定KEEPVERITY标记，默认为true\r\n" +
                $"-kfe=指定KEEPFORCEENCRYPT标记，默认为true\r\n" +
                $"-rm= 指定RECOVERYMODE标记\r\n" +
                $"     此选项在面具19000及更低版本无效，强制为false；在19100及更高版本默认为false\r\n" +
                $"-pvf=指定PATCHVBMETAFLAG标记\r\n" +
                $"     此选项在面具23000及更低版本无效，强制为false；在24000及更高版本默认为false\r\n" +
                $"-ls= 指定LEGACYSAR标记\r\n" +
                $"     此选项在面具25200及更低版本无效，强制为true；在25210及更高版本默认为false\r\n" +
                $"-pd= 指定PREINITDEVICE标记\r\n" +
                $"     此选项在25210及更低版本无效；在26000及更高版本默认为空\r\n");
            Environment.Exit(1);
        }
